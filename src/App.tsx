  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={wrapperStyle} className="privacy-policy-responsive-wrapper">
        <div style={{ width: '100%' }}>
          <h1 style={titleStyle} className="privacy-policy-responsive-title">Privacy Policy</h1>
          
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            <div style={{ display: 'flex', flexDirection: 'row', gap: '2rem' }}>
              <div style={{ flexGrow: 1 }}>
                <div style={sectionStyle} className="privacy-policy-responsive-section">
                ...
                <div id="info-collect" style={sectionStyle} className="privacy-policy-responsive-section">
                  ...
                  <h4 style={h4Style}>Information We Collect Directly From You</h4>
                  <p style={pStyle}>
                  ...
                  <h4 style={h4Style}>Information We Collect from Other Sources</h4>
                  <p style={pStyle}>
                ...
                <div id="how-use" style={sectionStyle} className="privacy-policy-responsive-section">
                  ...
                  <ul style={listStyle} className="privacy-policy-list">
                    <li style={listItemStyle}>
                      <span style={boldStyle}>Provide our Services:</span> To provide our Services, communicate 
                      with you about your use, respond to inquiries, fulfill orders, and support customers.
                    </li>
                    <li style={listItemStyle}>
                      <span style={boldStyle}>Provide personalized services:</span> To tailor content and information 
                    ...
                    <li style={listItemStyle}>
                      <span style={boldStyle}>Improve and develop our Services:</span> To ensure our Services work 
                    ...
                    <li style={listItemStyle}>
                      <span style={boldStyle}>Other legal reasons:</span> To enforce Terms of Service, comply with 
                ...
                <div id="how-share" style={sectionStyle} className="privacy-policy-responsive-section">
                  <h3 style={h3Style}>How We Share The Information We Collect</h3>
                  <p style={pStyle}>We may disclose information about you as follows:</p>
                  
                  <ul style={listStyle} className="privacy-policy-list">
                    <li style={listItemStyle}>
                      <span style={boldStyle}>Consent:</span> Where you have provided consent or directed us to 
                      disclose your information (e.g., when transacting with third parties through our Services).
                    </li>
                    <li style={listItemStyle}>
                      <span style={boldStyle}>Affiliates:</span> Among corporate affiliates that control, are 
                      controlled by, or under common control with MarvelX.
                    </li>
                    <li style={listItemStyle}>
                      <span style={boldStyle}>Vendors & Service Providers:</span> To third-party vendors, service 
                      providers, contractors, or agents performing functions on our behalf.
                    </li>
                    <li style={listItemStyle}>
                      <span style={boldStyle}>Business Transfers:</span> In connection with mergers, acquisitions, 
                      bankruptcy, or asset transfers.
                    </li>
                    <li style={listItemStyle}>
                      <span style={boldStyle}>In Response to Legal Process:</span> To comply with legal requirements 
                      or lawful requests by authorities.
                    </li>
                    <li style={listItemStyle}>
                      <span style={boldStyle}>To Protect Us and Others:</span> To investigate or prevent illegal 
                      activities, fraud, safety threats, violations of Terms, or as evidence in litigation or investigations.
                    </li>
                    <li style={listItemStyle}>
                      <span style={boldStyle}>Aggregate and De-Identified Information:</span> We may share 
                ...
                <div id="cookies" style={sectionStyle} className="privacy-policy-responsive-section">
                  <h3 style={h3Style}>Our Use of Cookies and Other Tracking Mechanisms</h3>
                  <p style={pStyle}>
                  ...
                  <ul style={listStyle} className="privacy-policy-list">
                    <li style={listItemStyle}>
                      <span style={boldStyle}>Cookies:</span> Alphanumeric identifiers transferred to your device 
                    ...
                    <li style={listItemStyle}>
                      <span style={boldStyle}>Disabling Cookies:</span> Most browsers accept cookies by default; 
                ...
                <div id="third-party" style={sectionStyle} className="privacy-policy-responsive-section">
                ...
                <div id="personal-info" style={sectionStyle} className="privacy-policy-responsive-section">
                  <h3 style={h3Style}>Personal Information Choices</h3>
                  
                  <h4 style={h4Style}>Your Rights Regarding Personal Information</h4>
                  <p style={pStyle}>
                    You may request access, correction, or deletion of personal information collected about you by 
                    contacting us at <a href="mailto:marvelxextension@gmail.com" style={emailStyle} className="privacy-policy-contact-email">marvelxextension@gmail.com</a>. We will comply with such requests as required by law, 
                ...
                <div id="contact" style={sectionStyle} className="privacy-policy-responsive-section">
                  <h3 style={h3Style}>Contact Us</h3>
                  <p style={pStyle}>
                    For questions about this Privacy Policy or privacy concerns, please contact us at 
                    <a href="mailto:marvelxextension@gmail.com" style={emailStyle} className="privacy-policy-contact-email"> marvelxextension@gmail.com</a>.
                  </p>
                </div>
                
                <div id="changes" style={sectionStyle} className="privacy-policy-responsive-section">
